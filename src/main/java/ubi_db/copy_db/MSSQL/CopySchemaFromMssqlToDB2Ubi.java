...
import ubi_db.connInfo.DB2ConnetionsInfoUbi;
 ...
 */
public class CopySchemaFromMssqlToDB2Ubi {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        connectorRepository.addConnectionInfo(SOURCE, new MSSQLConnectionsInfoUbi());
        connectorRepository.addConnectionInfo(TARGET, new DB2ConnetionsInfoUbi());
