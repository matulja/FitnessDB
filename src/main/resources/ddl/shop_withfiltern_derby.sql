...
ALTER TABLE orders ADD CONSTRAINT PK_orders_1 PRIMARY KEY (ordernumber);
...
ALTER TABLE orderdetails ADD CONSTRAINT FK_orderdetails_ordernumber_ordernumber_1 FOREIGN KEY (ordernumber) REFERENCES orders(ordernumber);
...
ALTER TABLE orders ADD CONSTRAINT FK_orders_customernumber_customernumber_1 FOREIGN KEY (customernumber) REFERENCES customers(customernumber);
...
CREATE UNIQUE INDEX IDX_ID_IX_IDX_DX_PRMRY_OFFCE1_OFFICES_1FFICES_1_OFFICS1_offics_1 ON offices(officecode);
CREATE UNIQUE INDEX IDX_IDX_IX_IDX_PK_FFICES_1_OFFICES_2_FFICES_2_OFFICES_2_office_2 ON offices(officecode);
CREATE UNIQUE INDEX IDX_IDX_IDX_PRIMARY_OFFICES_3_OFFICES_3_offices_3 ON offices(officecode);
CREATE UNIQUE INDEX IDX_IDX_PK_OFFICES_1_OFFICES_4_offices_4 ON offices(officecode);
CREATE UNIQUE INDEX IDX_PRIMARY_offices_5 ON offices(officecode);
...
CREATE UNIQUE INDEX IDX_IDX_IDX_IDX_IDX_PRIMRY_OR_1ORDERS_1_ORDERS_1ORDERS_1_order_1 ON orders(ordernumber);
CREATE UNIQUE INDEX IDX_IDX_IDX_IDX_PK_ORDERS_1_ORDERS_2_ORDERS_2_ORDERS_2_orders_2 ON orders(ordernumber);
CREATE UNIQUE INDEX IDX_IDX_IDX_PRIMARY_ORDERS_3_ORDERS_3_orders_3 ON orders(ordernumber);
CREATE UNIQUE INDEX IDX_IDX_PK_ORDERS_1_ORDERS_4_orders_4 ON orders(ordernumber);
CREATE UNIQUE INDEX IDX_PRIMARY_orders_5 ON orders(ordernumber);
CREATE INDEX IDX_IDX_IDX_IX_IXCUSTOMEUER_DERS_2_RDERS_3_ORERS_4RDERS_5_rdrs_6 ON orders(customernumber);
